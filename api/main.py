...
app = FastAPI(title="Morpheus API", version="1.0.0")
...
Morpheus Simulation Analysis
{'='*50}

TO:      {req.county} County Health Department
FROM:    Morpheus Policy Simulator
...
Generated by Morpheus — Catapult Hackathon 2026
"""
...
- Statewide: {statewide.get('headline', 'N/A')}"""
    ...
    system_prompt = f"""You are Morpheus AI — the intelligent assistant for Indiana's Opioid Policy Simulator. You have deep knowledge of the entire project.
